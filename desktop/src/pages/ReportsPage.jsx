    ...
    <div className="fade-up" style={{ padding:'1.5rem', overflowY:'auto', flex:1 }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'300px 1fr', gap:'1rem', alignItems:'start' }}>
        ...
        <div className="card" style={{ padding:'1.25rem' }}>
          ...
          <div style={{ background:'rgba(13,148,136,.08)', border:'1px solid rgba(13,148,136,.25)', borderRadius:7, padding:'.55rem .8rem', marginBottom:'.75rem', fontSize:'.74rem', color:'var(--slate)', lineHeight:1.55 }}>
            ⚠️ <strong>AI Confidence Disclaimer:</strong> The count and confidence values below are automatically generated by the AI model and reflect statistical predictions based on the current model iteration. These values may not be fully accurate and are expected to improve with subsequent model training iterations. They should be used as a <em>clinical aid only</em> and must be verified by the treating dental professional before inclusion in any formal report.
          </div>
            ...
            <table style={{ width:'100%', borderCollapse:'collapse', fontSize:'.78rem' }}>
              <thead>
                <tr style={{ background:'var(--navy)', color:'white' }}>
                  ...
                  <th style={{ padding:'.5rem .75rem', textAlign:'center', fontWeight:700, width:80 }}>Count</th>
                  ...
                  <tr key={key} style={{ background: i%2===0 ? 'white' : 'var(--light)' }}>
                    ...
                    <td style={{ padding:'.3rem .5rem', textAlign:'center' }}>
                      <input
                        ...
                        placeholder="—"
                        style={{ width:60, textAlign:'center', padding:'.25rem .4rem', border:'1px solid var(--border)', borderRadius:5, fontSize:'.78rem', background:'transparent', color:'var(--navy)', fontWeight:600 }}
                      />
                    </td>
                    <td style={{ padding:'.3rem .5rem', textAlign:'center' }}>
                      <input
